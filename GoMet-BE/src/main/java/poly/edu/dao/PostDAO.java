...
public interface PostDAO extends JpaRepository<Post, Integer> {
    ...
    List<Post> findLatest();
       ...
       @Query("SELECT COUNT(p) FROM Post p WHERE p.category.categoryID = :categoryId AND p.isApproved = 1 AND p.isActive = 1")
       long countVisibleByCategoryId(@Param("categoryId") Integer categoryId);
