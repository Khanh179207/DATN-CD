        ...
        <form @submit.prevent="handleSubmit" class="appeal-form">
          <div class="form-group">
            ...
            <input
              ...
              type="email"
              id="appeal-email"
              :placeholder="t('appeal.email_placeholder')"
              required
              class="input-field"
              :disabled="isSubmitting"
            />
            <small class="help-text">{{ $t('appeal.email_help') }}</small>
          </div>
          ...
          <div class="form-actions">
            ...
            >
              ...
              <span v-else>{{ $t('appeal.submit') }}</span>
            </button>
            <button
              v-else
              type="button"
...
const handleSubmit = async () => {
  ...
  try {
    ...
    toast.success(t('appeal.submit_ok'))
    ...
    submitError.value = t('appeal.submit_failed')
