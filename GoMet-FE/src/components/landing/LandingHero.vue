    ...
    <div class="hero-content" ref="contentWrapper">
      ...
      <h1 class="hero-title">
        <div class="reveal-wrapper perspective-box">
          <span class="gsap-reveal-text block text-shadow-glow">{{ $t('landing.title_1') }}</span>
        </div>
        <div class="reveal-wrapper perspective-box">
      ...
      <div class="reveal-wrapper">
        <p class="hero-desc gsap-desc">
          {{ $t('landing.desc_lead') }}
          <strong class="hero-desc-strong glow-text">{{ $t('landing.desc_highlight') }}</strong>
          {{ $t('landing.desc_tail') }}
        </p>
      </div>
      ...
      <div class="reveal-wrapper" style="overflow: visible;">
        <div class="cta-group gsap-cta">
          <a href="#" @click.prevent="handleExploreClick" class="btn-primary-xl shine-btn pulse-hover">
            <span class="btn-text">{{ $t('landing.cta') }}</span>
          ...
          <div class="social-proof">
            <div class="avatars">
              <img src="https://i.pravatar.cc/100?img=12" :alt="$t('common.user_avatar')">
              <img src="https://i.pravatar.cc/100?img=32" :alt="$t('common.user_avatar')">
              <img src="https://i.pravatar.cc/100?img=43" :alt="$t('common.user_avatar')">
