  ...
  <div class="tarot-ritual-master">
    ...
    <div class="ritual-wrapper">
      ...
      <div class="ritual-header-premium" ref="header">
        <span class="ritual-tagline">{{ t('suggestions.tarot_tagline') }}</span>
...
<div class="oracle-hand-wrap" v-if="gameState === 'dealt'" ref="handWrapRef">
  <div class="hand-inner-float">
    <img src="@/assets/images/hand.png" class="real-hand-img" :alt="t('suggestions.tarot_hand_alt')" />
...
const statusText = ref(t('suggestions.tarot_status_idle'))
const cardRefs = reactive([])
const handWrapRef = ref(null)

// 🃏 KHO BÀI TAROT (Pool) - Đã mở rộng để random thật sự
const tarotPool = [
  { name: t('suggestions.tarot_card_flame_name'), icon: '🔥', desc: t('suggestions.tarot_card_flame_desc') },
  { name: t('suggestions.tarot_card_ocean_name'), icon: '🌊', desc: t('suggestions.tarot_card_ocean_desc') },
  { name: t('suggestions.tarot_card_earth_name'), icon: '🌿', desc: t('suggestions.tarot_card_earth_desc') },
  { name: t('suggestions.tarot_card_sky_name'), icon: '☁️', desc: t('suggestions.tarot_card_sky_desc') },
  { name: t('suggestions.tarot_card_star_name'), icon: '✨', desc: t('suggestions.tarot_card_star_desc') },
  { name: t('suggestions.tarot_card_harvest_name'), icon: '🌾', desc: t('suggestions.tarot_card_harvest_desc') },
  { name: t('suggestions.tarot_card_shadow_name'), icon: '🌒', desc: t('suggestions.tarot_card_shadow_desc') }
]
...
const startRitual = () => {
  ...
  statusText.value = t('suggestions.tarot_status_shuffle')
...
const dealCards = () => {
  ...
  statusText.value = t('suggestions.tarot_status_choose')
  nextTick(() => {
    // Bài rơi xuống
...
const flipCard = (index) => {
  ...
  statusText.value = t('suggestions.tarot_status_reveal');
  const card = cardRefs[index];
