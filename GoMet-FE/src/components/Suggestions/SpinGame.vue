  ...
  <div class="game-stage premium-game">
    <div class="machine-container">
      ...
      <button class="btn-spin-premium" @click="spinWheel" :disabled="isSpinning || isRevealing">
        <span v-if="!isSpinning">{{ $t('suggestions.spin_btn', 'Quay Tuyệt Tác') }}</span>
        <span v-else class="spinning-text">
          Đang dò tìm <span class="dots">...</span>
        </span>
      </button>
...
const scrambledText = ref(currentDisplayDish.value.name || 'Sẵn sàng')
