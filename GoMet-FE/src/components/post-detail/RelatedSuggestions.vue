  ...
  <aside class="related-sidebar-wrapper">
    ...
    <div class="related-container">
      <div class="sidebar-header">
        ...
        <h3 class="main-title">{{ t('post.related_title_prefix') }} <span class="highlight">{{ t('post.related_title_highlight') }}</span></h3>
      </div>
