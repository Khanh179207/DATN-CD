        ...
        <div class="sticky-content-wrapper">
          ...
          <div v-if="parsedVideo" class="video-card-luxury slide-in-left">
            <div class="card-header-dark">
              ...
              <button class="btn-theater-toggle" @click="isTheater = !isTheater" :title="isTheater ? t('common.collapse') : t('common.expand')">
            ...
            <div class="video-aspect-frame">
              <iframe v-if="parsedVideo.type === 'youtube'" :src="parsedVideo.url" :title="t('common.recipe_video')" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <div class="premium-widget ingredients-widget">
              <div class="widget-header">
                <div class="title-with-icon">
                  ...
                  <h3>{{ $t('recipe.ingredients_cart') }}</h3>
                </div>
              ...
              <button class="btn-gradient-orange w-full" @click="handleGoShopping">
                <span>{{ $t('recipe.add_to_cart') }}</span>
            ...
            <div class="premium-widget note-widget">
              ...
              <div class="note-actions">
                ...
                <button class="btn-text-save" @click="handleSaveNote" :disabled="isSavingNote">
                   {{ isSavingNote ? $t('common.loading') : $t('recipe.personal_note_save') }}
                </button>
              </div>
            </div>
...
const handleSaveNote = async () => {
  if (!authStore.isAuthenticated) return toast.warn(t('toast.need_login_note'));
  ...
  try {
    ...
    toast.success(t('toast.note_saved'));
...
const handleGoShopping = () => {
  ...
  if (!selected.length) return toast.warn(t('toast.need_select_ingredients'));
  shoppingStore.addItems(selected, props.post.id)
  toast.success(t('toast.shopping_added', { count: selected.length }))
}
