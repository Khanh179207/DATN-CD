      ...
      <div class="container hero-content" :key="currentIndex">
        ...
        <div class="text-side">
          ...
          <div class="meta-info-line">
            ...
            <div class="meta-item views" :style="{ color: currentSlideData.themeColor }">
              ...
              <span>{{ currentSlideData.views }} {{ t('home.hero_views') }}</span>
            </div>
          </div>
          ...
          <div class="cta-group">
            ...
            <button class="btn-secondary" :style="secondaryBtnStyle">
              ...
              <span>{{ t('home.hero_tutorial_video') }}</span>
            </button>
          </div>
        </div>
        ...
        <div class="visual-side">
          <div class="composition-container" :style="parallaxStyle(20)">
            ...
            <img v-if="currentSlideData.float2.isImg" :src="currentSlideData.float2.src" class="float-obj obj-2" :style="parallaxStyle(-25)" :alt="t('common.decorative_image')">
            ...
            <div class="review-card-pro" :style="parallaxStyle(15)">
              <div class="user-info">
                <img :src="currentSlideData.review.avatar" :alt="t('common.user_avatar')">
                <div>
                  <div class="u-name">{{ currentSlideData.review.name }}</div>
                  <div class="u-role">{{ t('home.hero_vip_member') }}</div>
                </div>
              </div>
...
const slideTemplates = [
  {
    badge: t('home.hero_badge_weekly'),
    titleTop: t('home.hero_title_masterpiece'),
    themeColor: "#EA580C",
    ...
    float1: { isImg: false, text: t('home.hero_float_garlic') },
    float2: { isImg: true, src: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Basil.png/800px-Basil.png" },
    float3: { isImg: false, text: t('home.hero_float_herb') },
    review: { name: "Khanh Nguyen", avatar: "https://ui-avatars.com/api/?name=KN&background=F97316&color=fff", comment: t('home.hero_review_comment_1') }
  },
  {
    badge: t('home.hero_badge_weekend'),
    titleTop: t('home.hero_title_premium'),
    themeColor: "#DC2626",
    ...
    float1: { isImg: false, text: t('home.hero_float_spice') },
    float2: { isImg: false, text: t('home.hero_float_herb') },
    float3: { isImg: false, text: t('home.hero_float_sauce') },
    review: { name: "Minh Anh", avatar: "https://ui-avatars.com/api/?name=MA&background=DC2626&color=fff", comment: t('home.hero_review_comment_2') }
  },
  {
    badge: "Eat Clean Menu",
    titleTop: t('home.hero_title_refreshing'),
    themeColor: "#16A34A",
    ...
    float1: { isImg: false, text: t('home.hero_float_fresh') },
    float2: { isImg: false, text: t('home.hero_float_greens') },
    float3: { isImg: false, text: t('home.hero_float_healthy') },
    review: { name: "Lan Phuong", avatar: "https://ui-avatars.com/api/?name=LP&background=16A34A&color=fff", comment: t('home.hero_review_comment_3') }
  }
]
...
const slides = ref(slideTemplates.map(t => ({
  ...
  desc: t('home.hero_desc_default'),
  time: `30 ${t('common.minutes')}`,
    ...
    if (posts && posts.length > 0) {
      slides.value = posts.slice(0, 3).map((dto, i) => {
        ...
        return {
          ...
          desc: p.description || t('home.hero_desc_featured'),
          time: p.time || `30 ${t('common.minutes')}`,
          difficulty: p.difficulty || t('common.easy'),
