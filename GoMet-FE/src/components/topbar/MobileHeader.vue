          ...
          <div class="m-dropdown-content" @click.stop>
            ...
            <div v-if="showShopping" class="m-drop-pane">
              <div class="m-drop-head">
                <div class="m-head-title">
                  ...
                  <div class="m-head-links">
                    <button v-if="shoppingStore.items.some(i => i.checked)" class="m-link danger"
                      @click="shoppingStore.removeCheckedItems()">Xóa đã tick</button>
                    <button v-if="shoppingStore.items.length > 0" class="m-link" @click="shoppingStore.clearItems()">Xóa
                      hết</button>
                  </div>
                </div>
              ...
              <div class="m-drop-body custom-scroll">
                ...
                <div v-else v-for="(item, idx) in shoppingStore.items" :key="idx" class="m-list-item"
                  :class="{ 'checked': item.checked }" @click="shoppingStore.toggleItem(idx)">
                  <div class="m-check-box">
                    <svg v-if="item.checked" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="4">
            ...
            <div v-if="showNoti" class="m-drop-pane">
              <div class="m-drop-head">
                <div class="m-head-title">
                  <h3>Thông báo</h3>
                  <div class="m-head-links">
                    <button v-if="unreadNotiCount > 0" class="m-link" @click="handleMarkAllRead">Đánh dấu đã
                      đọc</button>
              ...
              <div class="m-drop-body custom-scroll">
                ...
                <div v-else v-for="n in notifications" :key="n.id" class="m-noti-item" :class="{ 'unread': !n.isRead }"
...
.m-search-area :deep(.icon-prefix) {
...
.m-list-item.checked .m-check-box {
  background: #ea580c;
  border-color: #ea580c;
  color: white;
}
...
.m-item-qty {
  ...
  font-weight: 500;
  color: #ea580c;
  /* Màu cam nổi bật để phân biệt bài viết */
}
...
.is-dark-theme.mobile-header {
  background: #11100F;
  border-bottom-color: #262626;
}

.is-dark-theme .m-btn-icon,
.is-dark-theme .hamburger-trigger {
  color: white;
}
