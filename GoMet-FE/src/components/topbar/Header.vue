  ...
  <div v-if="showShopping" class="common-dropdown shopping-width modern-shopping-dropdown">
    <div class="dropdown-header">
      ...
      <div class="header-right">
        ...
        <button class="action-link" @click="shoppingStore.clearItems()">
          Xóa hết
        </button>
      </div>
    </div>
    ...
    <div class="dropdown-body scroll-body custom-scroll">
      ...
      <div v-else class="shopping-cards-stack">
        <div v-for="(item, idx) in shoppingStore.items" 
             :key="idx" 
             class="shopping-card-v3" 
          ...
          <button class="btn-remove-item" @click.stop="shoppingStore.removeItem(idx)" title="Xóa món này">
    ...
    <Teleport to="body">
      <transition name="fade"><div v-if="showBugReport" class="modal-backdrop" @click.self="showBugReport = false"></div></transition>
...
const handleCreatePost = () => {
  authStore.isAuthenticated ? router.push('/create-post') : emit('open-login')
}
