<template>
  <div class="app-container" :class="{ 'is-dark-theme': route.meta?.isDark }">
    ...
    <Transition name="fade-loader">
      <div v-if="isLoading" class="app-preloader">
        ...
        <div class="loader-content">
          ...
          <p class="loader-text">{{ t('common.welcome_to_gomet') }}</p>
    ...
    <button class="float-ai-btn" @click="openAiChat" :title="t('chat.ai_name')">
...
const handleClosePremium = () => { showPremium.value = false; if (isEnforcingRenewal.value) { showExpired.value = true; toast.error(i18n.global.t('toast.premium_renew_required')); } };
