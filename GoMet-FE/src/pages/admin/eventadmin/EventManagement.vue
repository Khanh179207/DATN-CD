  ...
  <div class="gomet-admin-pro">
    ...
    <div class="stats-bar">
      <div class="stat-item">
        ...
        ><span class="s-val">{{ events?.length || 0 }}</span>
      </div>
      ...
      <div class="divider"></div>
      <div class="stat-item">
        <span class="s-label">Tổng bài thi</span
        ><span class="s-val text-orange">{{ totalPostCount }}</span>
      </div>
    </div>
    ...
    <div v-else class="event-list-container">
      <AdminEventCard
        ...
        :key="
          ev.eventID + '-' + (ev.isActive || 0) + '-' + (ev.isForceEnded || 0)
        "
        :ev="ev"
          ...
          <div class="modal-scroll-area">
            ...
            <div class="form-group">
              ...
              <input
                ...
                type="text"
                placeholder="VD: Top Chef Gomet 2026"
                :disabled="isViewOnly"
              />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="upload-zone" :class="{ 'disabled-zone': isViewOnly }">
                ...
                <div v-if="!imagePreview" class="upload-placeholder">
                  <label v-if="!isViewOnly" for="fileUpload" class="btn-upload"
                    >Tải ảnh lên</label
                  >
            ...
            <div class="form-grid">
              <div class="form-column">
                ...
                <div class="form-group">
                  ...
                  <select v-model="form.rewardType" :disabled="isViewOnly" style="width: 100%; padding: 12px 16px; border: 1px solid #dbe4ee; border-radius: 12px; font-size: 0.95rem; background: #ffffff; cursor: pointer; transition: all 0.28s ease;">
                  ...
                  <!-- PREMIUM -->
                  <div
                    v-if="form.rewardType === 'premium'"
                    class="form-group mt-3"
                  >
                    <label>Thời gian Premium cho Top 1 (ngày)</label>
                    <input
                      v-model.number="form.premiumDaysTop1"
                      type="number"
                      min="1"
                      placeholder="VD: 30"
                      :disabled="isViewOnly"
                    ...
                    <input
                      v-model.number="form.premiumDaysTop2"
                      type="number"
                      min="1"
                      placeholder="VD: 15"
                      :disabled="isViewOnly"
                    ...
                    <input
                      v-model.number="form.premiumDaysTop3"
                      type="number"
                      min="1"
                      placeholder="VD: 7"
                      :disabled="isViewOnly"
              ...
              <div class="form-column">
                ...
                <div class="form-group">
                  ...
                  ><input
                    v-model="form.voteStartAt"
                    type="datetime-local"
                    :disabled="isViewOnly"
                  />
                </div>
                <div class="form-group">
                  <label>Kết thúc bình chọn</label
                  ><input
                    v-model="form.voteEndAt"
                    type="datetime-local"
                    :disabled="isViewOnly"
                  />
                </div>
    ...
    <Transition name="zoom-in">
      <div
        v-if="showConfirmEndModal"
        class="modal-overlay"
        @click.self="showConfirmEndModal = false"
      >
    ...
    <Transition name="zoom-in">
      <div
        v-if="showDeleteRestoreModal"
        class="modal-overlay"
        @click.self="showDeleteRestoreModal = false"
      >
        <div class="confirm-modal">
          <div
            class="icon-warning"
            :style="{ color: isActionSoftDelete ? '#ef4444' : '#10b981' }"
          >
            <i
              :class="isActionSoftDelete ? 'fas fa-trash-alt' : 'fas fa-redo'"
            ></i>
          </div>
      ...
      >
        <div class="winner-modal-card">
          ...
          <div v-else class="winner-content">
            ...
            <img
              :src="getImageUrl(winnerData.postImage)"
              alt="Winning Recipe"
              class="winner-recipe-img"
            />
